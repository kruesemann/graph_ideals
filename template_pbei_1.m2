...
-- Scripts will compute the degrees of h-polynomials of quotient rings of the parity binomial edge ideals of the graphs G_i.
...
I = pbei graph G_i;                                              -- change "pbei" here
